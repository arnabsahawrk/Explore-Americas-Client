            ...
            <div className="container mx-auto flex flex-col justify-center items-center gap-3 h-full">
              <ul className="flex gap-2">
                ...
                >
                  ...
                  >
                    Tourist Spots <IoIosArrowDropright />
                  </NavLink>
                </Typography>
              </ul>
              <Slide>
                ...
                >
                  Explore the Americas&apos; diverse wonders.
                </Typography>
              </Slide>
              ...
              >
                <Fade delay={1e3} cascade damping={1e-1}>
                  Embark on a journey through the Americas&apos; captivating
                  destinations.
                </Fade>
              </Typography>
            </div>
...
export default TouristSpotsBanner;
